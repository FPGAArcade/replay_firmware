...
// added
// same as FF_READ but no cache. Will flush any writes
// requires FF_CACHE_WRITE_THROUGH as cache is not flushed first
// will error out if read not block aligned
