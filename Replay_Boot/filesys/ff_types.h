...
typedef	uint8_t				FF_T_UINT8;		///< 8 bit unsigned integer.
typedef int8_t				FF_T_SINT8;		///< 8 bit signed integer.

//---------------- 16 BIT INTEGERS
typedef	int16_t				FF_T_INT16;		///< 16 bit default integer.
typedef	uint16_t			FF_T_UINT16;	///< 16 bit unsigned integer.
typedef	int16_t				FF_T_SINT16;	///< 16 bit signed integer.

//---------------- 32 BIT INTEGERS
typedef	int32_t				FF_T_INT32;		///< 32 bit default integer.
typedef	uint32_t			FF_T_UINT32;	///< 32 bit unsigned integer.
typedef	int32_t				FF_T_SINT32;	///< 32 bit signed integer.
...
typedef int64_t			FF_T_INT64;		// about 64-bit number support.
typedef uint64_t		FF_T_UINT64;	// It means that FF_GetVolumeSize() cannot return a size
typedef int64_t			FF_T_SINT64;	// > 4GB in bytes if you cannot support 64-bits integers.
