...
static const uint8_t DeviceDescriptor[] = {
    ...
    0x00, 0x02,                 // Complies with USB Spec. Release 2.0
    0x00,                       // Class code (0)
    ...
    0x02, 0x01,                 // Device release number (0001)
...
static const uint8_t ConfigurationDescriptor[] = {
    ...
    0x03,                       // Number of interface endpoint (2)
    0xff,                       // Class code (HID)
    0xff,                       // Subclass code ()
    0x00,                       // Protocol code ()
    0x04,                       // Index of string()
